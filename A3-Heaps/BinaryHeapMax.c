...
-------------------    Problem 6    -------------------
-----------------------------------------------------*/
//Same as min, but things are flipped
...
{
	//Initializes the heap in memory
...
void reHeapUp(Heap *heap, int index)
{
	...
	reHeapUp(heap, parent_index); //ReHeapUp again encase it's still not balanced
}
